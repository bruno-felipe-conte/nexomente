...
export default function Button({ 
  ...
  const baseStyles = "inline-flex items-center justify-center font-medium transition-all duration-150 rounded-xl outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-accent-main";
  ...
  const sizes = {
    ...
    md: "px-4 py-2 text-[15px] min-h-[44px] gap-2",
    lg: "px-6 py-3 text-base min-h-[52px] gap-2",
    none: "" // for icon-only
  };
